...
- (void)viewDidLoad {
    ...
    CHMBarButtonItem *leftButton = [[CHMBarButtonItem alloc] initContainImage:[UIImage imageNamed:imageStr] imageViewFrame:CGRectMake(0, 4, 10, 17) buttonTitle:nil
                                                        titleColor:nil
...
- (void)loadSearchView {
    self.searchView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH - 25, 44)];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    self.navigationController.navigationBar.barTintColor = [UIColor chm_colorWithHexString:@"#0099ff" alpha:1.0];
