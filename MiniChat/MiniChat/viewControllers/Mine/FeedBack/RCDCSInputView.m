...
- (UITextView *)suggestText{
  if (!_suggestText) {
    ...
    _suggestText.textColor = [UIColor chm_colorWithHexString:@"0x939dab" alpha:1.0];
...
- (UITextView *)placeHolderText{
  if (!_placeHolderText) {
    ...
    _placeHolderText.textColor = [UIColor chm_colorWithHexString:@"0x939dab" alpha:1.0];
    _placeHolderText.backgroundColor = [UIColor chm_colorWithHexString:@"0xf1f3f5" alpha:1.0];
